...
/**
 * Convert type Responsive to CSS property and this type
 * @param propKey CSS property
 * @param prop type Responsive
 * @param theme ApTheme
 * @returns CSS property and value (ex. background-color: white;)
*/
...
const LINE_SPACEING_KEYS = new Set(['letter-spacing'])
